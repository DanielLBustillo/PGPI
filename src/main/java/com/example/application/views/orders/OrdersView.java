...
@Route(value = "Orders/:samplePersonID?/:action?(edit)", layout = MainView.class)
@PageTitle("Orders")
@CssImport("./views/orders/orders-view.css")
public class OrdersView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "Orders/%d/edit";
    ...
    public OrdersView(@Autowired SamplePersonService samplePersonService) {
